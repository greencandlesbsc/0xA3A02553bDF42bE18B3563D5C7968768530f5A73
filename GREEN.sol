...
contract GreenCandles is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFd595B5Eb88d8242f48f7e492385A505d712F5E7); // Marketing Address
    address payable public charityAddress = payable(0x0A5E7C50eA6BB695F234e75D97D3381592B59C9F); // Charity Address
    ...
    string private _name = "GreenCandles";
    ...
    uint256 public _maxTxAmount = 45 * 10**11 * 10**9;
    uint256 private minimumTokensBeforeSwap = 30 * 10**11 * 10**9;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Marketing address and charity address
